...
const App=(props)=>{
  ...
  return (
    <div>
      ...
      <StatsContainer customers={customers} uniqueCustomers={uniqueCustomers} ordersTotal={ordersTotal} />
      <CustomerContainer customers={customers} uniqueCustomers={uniqueCustomers}/>
